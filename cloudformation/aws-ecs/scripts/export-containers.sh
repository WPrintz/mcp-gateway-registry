...
#   SOURCE_VERSION       - git branch to build from (default: cloudformation/workshop-v1.0.20)
#   IMAGE_TAG            - image tag for docker save (default: v1.0.20)
...
SOURCE_VERSION="${SOURCE_VERSION:-cloudformation/workshop-v1.0.20}"
IMAGE_TAG="${IMAGE_TAG:-v1.0.20}"
